...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="<?php bloginfo('template_directory');?>/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    ...
    <script src="<?php bloginfo('template_directory');?>/js/classy-nav.min.js"></script>
    <script src="<?php bloginfo('template_directory');?>/js/jquery-ui.min.js"></script>
    <!-- Active js -->
    <script src="<?php bloginfo('template_directory');?>/js/active.js"></script>
